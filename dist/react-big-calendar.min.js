!(function(e, t) {
  ...
  var M = u(function(e, t) {
    ...
    x = (m.oneOfType([D, m.shape({ month: D, week: D, day: D, agenda: D })]),
    Object.keys(j).map(function(e) {
      return j[e]
    }))
  m.oneOfType([m.string, m.func]),
    m.any,
    m.func,
    m.oneOfType([
      m.arrayOf(m.oneOf(x)),
      T(m.object, function(e, t) {
        for (
  ...
  var C = m.oneOfType([m.string, m.func])
  var N = function(e) {
    var t = this
  ...
  var he = function(e) {
    ...
    ye = '[object Symbol]'
  var ge = function(e) {
      return 'symbol' == typeof e || (he(e) && ne(e) == ye)
    },
    be = NaN,
    we = /^\s+|\s+$/g,
    _e = /^[-+]0x[0-9a-f]+$/i,
  ...
  var Ne = function(e, t, n) {
      t = (n ? me(e, t, n) : void 0 === t) ? 1 : Ce(xe(t), 0)
    ...
    return (
      ...
      (r.render = function() {
        var e = this.props,
          ...
          v = d.width,
          m = d.top,
          h = (this.state || {}).topOffset || 0,
          y = (this.state || {}).leftOffset || 0,
          g = { top: Math.max(0, m - h), left: p - y, minWidth: v + v / 2 }
        return n.createElement(
          'div',
  ...
  var ht = u(function(e, t) {
    Object.defineProperty(t, '__esModule', { value: !0 })
    var n,
      r = (n = mt) && n.__esModule ? n : { default: n }
    function o(e, t) {
      if (t)
        do {
          if (t === e) return !0
  ...
  var Dt = u(function(e, t) {
    ...
    var r = 'transform',
      ...
      p = void 0,
      v = void 0
    if (((n = mt) && n.__esModule ? n : { default: n }).default) {
      var m = (function() {
        for (
  ...
  var Rt = u(function(e, t) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 })
    var r = function() {}
    ;((n = mt) && n.__esModule ? n : { default: n }).default &&
  ...
  var $n = function(e) {
      var t = this.__data__
      return zn ? void 0 !== t[e] : Yn.call(t, e)
    },
  ...
  var br = function(e, t, n, r, o, a) {
      ...
      for (a.set(e, t), a.set(t, e); ++c < s; ) {
        ...
        if (d) {
          if (
            !mr(t, function(e, t) {
              if (!hr(d, t) && (p === e || o(p, e, n, r, a))) return d.push(t)
            })
          ) {
            f = !1
            break
  ...
  var Kr = function(e) {
    ...
    Qr = Kr(
      ...
      ? Kr
      : function(e) {
          return he(e) && Zr.call(e, 'callee') && !Jr.call(e, 'callee')
        }
  var eo = function() {
      return !1
    },
  ...
  var ro = function(e) {
    return he(e) && ce(e.length) && !!no[ne(e)]
  }
  var oo = function(e) {
      return function(t) {
        return e(t)
  ...
  var ho = function(e) {
    if (!fo(e)) return vo(e)
    var t = []
    for (var n in Object(e)) mo.call(e, n) && 'constructor' != n && t.push(n)
    return t
  }
  var yo = function(e) {
    return fe(e) ? uo(e) : ho(e)
  }
  var go = function(e) {
      return Hr(e, yo, $r)
    },
  ...
  var _o = function(e, t, n, r, o, a) {
      ...
      for (var p = i; ++u < l; ) {
        var v = e[(c = s[u])],
          m = t[c]
        if (r) var h = i ? r(m, v, c, t, e, a) : r(v, m, c, e, t, a)
        if (!(void 0 === h ? v === m || o(v, m, n, r, a) : h)) {
          d = !1
          break
        }
        p || (p = 'constructor' == c)
  ...
  var ba = function(e, t) {
    return Ko(e) && Uo(t)
      ...
      : function(n) {
          var r = pa(n, e)
          return void 0 === r && r === t ? ha(n, e) : zo(t, r, ya | ga)
        }
  }
  var wa = function(e) {
    return e
  ...
  ;(qa.propTypes = {}), (qa.defaultProps = { minRows: 0, maxRows: 1 / 0 })
  var Ya = function(e) {
    var t = e.label
    ...
    Xa = (function(e) {
        ...
        return (
          ...
          (r.readerDateHeading = function(e) {
            var t = e.date,
              ...
              p = z.eq(t, u, 'day'),
              v = c(t),
              m = f.format(t, 'dateFormat'),
              h = r.props.components.dateHeader || $a
            return n.createElement(
              'div',
              o({}, s, {
      ...
      return (
        (s.componentWillReceiveProps = function(e) {
          var t = e.date
          this.setState({
            needLimitMeasure: !z.eq(t, this.props.date, 'month'),
          })
        }),
  ...
  function Za(e) {
    ...
    return (
      f.push(
        new Date(t.getFullYear(), t.getMonth(), t.getDate(), 0, s + h, 0, 0)
      ),
      {
        groups: c,
        update: function(e) {
  ...
  var Qa = Y ? Y.isConcatSpreadable : void 0
  var ei = function(e) {
      ...
      return (
        ...
        (r.renderEvents = function() {
          ...
          return Mi({
            ...
            accessors: i,
            slotMetrics: p,
            minimumStartDifference: d || Math.ceil((c * f) / 2),
          }).map(function(e, t) {
            var c,
              f = e.event,
              d = e.style,
              ...
              g = p.startsBeforeDay(h),
              b = p.startsAfterDay(m)
            g
              ? (y = 'eventTimeRangeEndFormat')
              : b && (y = 'eventTimeRangeStartFormat'),
              (c = g && b ? v.allDay : s.format({ start: h, end: m }, y))
            var w = g || p.startsBefore(h),
              _ = b || p.startsAfter(m)
    ...
    return (
      ...
      (s.render = function() {
        var e = this.props,
          ...
          g = h.top,
          w = h.height,
          _ = { start: h.startDate, end: h.endDate },
          E = c(t),
          O = E.className,
          M = E.style
        return n.createElement(
    ...
    return (
      ...
      (r.render = function() {
        var e = this,
          ...
          w = void 0 === g ? Ni : g,
          _ = {}
        m && (_[o ? 'marginLeft' : 'marginRight'] = Ci() + 'px')
        ...
        return n.createElement(
          'div',
          {
            style: _,
            ref: p,
            className: b('rbc-time-header', m && 'rbc-overflowing'),
          },
          n.createElement(
            'div',
            {
        ...
        return (
          ((t = e.call.apply(e, [this].concat(o)) || this).renderDay = function(
            ...
            return (r = r.filter(function(t) {
              ...
              return n.createElement(
                'tr',
                { key: o + '_' + c, className: h.className, style: h.style },
                g,
                n.createElement(
                  'td',
  ...
  var cl = function e(t, n, r, o, a, i) {
    ...
    var m = c ? (u ? vs : go) : u ? keysIn : yo,
      h = f ? void 0 : m(t)
    return (
      Zi(h || t, function(o, a) {
        h && (o = t[(a = o)]), es(s, a, e(o, n, r, a, t, i))
      }),
      s
    )
  }
    ...
    return (
      ...
      (r.render = function() {
        ...
        var h = this.getView(),
          ...
          O = y.viewNames,
          M = w.toolbar || Gi,
          D = h.title(c, { localizer: E, length: d })
        return n.createElement(
          'div',
          o({}, u, {
